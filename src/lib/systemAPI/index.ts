...
export const systemAPI = {
  ...
  bootstrapStartupHealth: hermesAPI.bootstrapStartupHealth.bind(hermesAPI),
  runStartupAutoFix: hermesAPI.runStartupAutoFix.bind(hermesAPI),
  ...
  parseGatewayStartupRecoverySignals: hermesAPI.parseGatewayStartupRecoverySignals.bind(hermesAPI),
  ...
  ensureWhatsAppManagedNode: hermesAPI.ensureWhatsAppManagedNode.bind(hermesAPI),
  patchGatewayServicePathForWhatsApp: hermesAPI.patchGatewayServicePathForWhatsApp.bind(hermesAPI),
